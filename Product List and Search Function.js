...
function search_product() {
  if (document.getElementById("search_product_value").value != "")
    ...
    {alert("Please enter some words before searching!")}
};
...
function find_product() {
    ...
    <ul id="ul">
      ...
      <li><a href="abc Online Supermarket - Serach Product Page.html" 
      onclick='localStorage.setItem("product", "Banana")'>Banana (1 comb)</a>
      </li>
    ...
    for (i = 0; i < li.length; i++) {
        ...
        if (search_value.toUpperCase().indexOf(filter) > -1 & document.getElementById("search_product_value").value != "") 
          {li[i].style.display = "";
           ul.style = `outline: 3px solid black; overflow: auto; width: 259px; height: 300px`}   
        else 
